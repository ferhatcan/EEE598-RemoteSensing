...
class UNet_conditional_WO_Self(UNet_WO_Self):
    def __init__(self, c_in=3, c_out=3, time_dim=256, num_classes=None):
        super().__init__(c_in, c_out, time_dim)
        if num_classes is not None:
            self.label_emb = nn.Embedding(num_classes, time_dim)
...
class UNet_Classic(nn.Module):
    def __init__(self, c_in=3, c_out=3):
        super().__init__()
        self.inc = DoubleConv(c_in, 64)
        self.down1 = Down_Classic(64, 128)
        self.sa1 = SelfAttention(128)
        self.down2 = Down_Classic(128, 256)
        self.sa2 = SelfAttention(256)
        self.down3 = Down_Classic(256, 256)
        self.sa3 = SelfAttention(256)
        ...
        self.up1 = Up_Classic(512, 128)
        self.sa4 = SelfAttention(128)
        self.up2 = Up_Classic(256, 64)
        self.sa5 = SelfAttention(64)
        self.up3 = Up_Classic(128, 64)
        self.sa6 = SelfAttention(64)
        self.outc = nn.Conv2d(64, c_out, kernel_size=1)
